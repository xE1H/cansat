...
from hardware.PiicoDev_Unified import *
...
class PiicoDev_ENS160(object):
    def __init__(self, bus=None, freq=None, sda=None, scl=None, address=_I2C_ADDRESS, asw=None, intdat=False,
                 intgpr=False, int_cfg=0, intpol=0, temperature=25.0, humidity=50.0):
        if asw == 0:
            self.address = _I2C_ADDRESS
        elif asw == 1:
            self.address = _I2C_ADDRESS - 1
        else:
