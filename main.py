...
import datapacker
import lora_e220_constants
from hardware import lora_e220, micropyGPS, bmp280, bme280, ms5611, sim800l
...
########## I2C SETUP ############
i2c_main = machine.SoftI2C(scl=machine.Pin(3), sda=machine.Pin(5))
print([i for i in i2c_main.scan()])  # ['0x68' -- 6500, '0x76' -- bmp, '0x77' -- ms5611]

i2c_secondary = machine.SoftI2C(scl=machine.Pin(11), sda=machine.Pin(12))  # todo
...
while True:
    ...
    if gps.any():
        ...
        d["lat"] = gps_parser.latitude[0]
        d["lon"] = gps_parser.longitude[0]
        ...
        d["gps_sats"] = gps_parser.satellites_in_use
