...
class Quaternion:
    ...
    def conj(self):
        ...
        """
        return Quaternion(self._q[0, 0], -self._q[0, 1], -self._q[0, 2], -self._q[0, 3])
    ...
    def __mul__(self, other):
        ...
        if isinstance(other, Quaternion):
            w = self._q[0, 0] * other._q[0, 0] - self._q[0, 1] * other._q[0, 1] - self._q[0, 2] * other._q[0, 2] - \
                self._q[0, 3] * other._q[0, 3]
            x = self._q[0, 0] * other._q[0, 1] + self._q[0, 1] * other._q[0, 0] + self._q[0, 2] * other._q[0, 3] - \
                self._q[0, 3] * other._q[0, 2]
            y = self._q[0, 0] * other._q[0, 2] - self._q[0, 1] * other._q[0, 3] + self._q[0, 2] * other._q[0, 0] + \
                self._q[0, 3] * other._q[0, 1]
            z = self._q[0, 0] * other._q[0, 3] + self._q[0, 1] * other._q[0, 2] - self._q[0, 2] * other._q[0, 1] + \
                self._q[0, 3] * other._q[0, 0]
